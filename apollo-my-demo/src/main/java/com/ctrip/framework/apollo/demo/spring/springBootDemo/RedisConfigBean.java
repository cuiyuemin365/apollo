 ...
 * and <code>redis.cache.enabled</code> should also be set to true. Check 'src/main/resources/application.properties' for more information.
 *
 * @author Jason Song(song_s@ctrip.com)
 */
@ConditionalOnProperty("redis.cache.enabled")
@ConfigurationProperties(prefix = "redis.cache")
@Component("redisConfigBean")
@org.springframework.cloud.context.config.annotation.RefreshScope
public class RedisConfigBean {

  private static final Logger logger = LoggerFactory.getLogger(RedisConfigBean.class);
